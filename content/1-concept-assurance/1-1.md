...
One State of the Art computer vision technique is the You Only Look Once ([YOLO](cite:53)) detection system. YOLO has been applied to rail through experiments on the [Roboflow](cite:54) platform, to [mixed results](cite:55). The company [Railvision](cite:railvision) suggests that 2km of continuous vision is required for CV operation, through our own experimentation, we are aware of software such as [DIST-YOLO](cite:56) which attempts to scope YOLO functionality regarding distance from camera, however, DIST-YOLO does not claim to work past 150m. 
