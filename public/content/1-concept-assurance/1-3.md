### Operating Area Determination

**Purpose.** 
Draft a *top-level Operational Domain Model (ODM)* as a **state machine** describing the journey lifecycle.
...
A reviewable narrative + schematic that stakeholders validate before Step 2 hazards.
