...
slug: '4-metrics',
summary: 'Formalise the relationship between Hazard, Requirement and Metric. Metrics define the operational limits within which the system can safely function and against which future technologies will later be assessed. In practice, a metric is any quantifiable constraint that directly influences the safe behaviour of the ego-vehicle within its ecosystem.',
diagramSrc: 'diagrams/Step-4.svg',
subHotspots: [
    { id: 'd6',  label: 'Deliverable D6',     kind: 'info', x: 0, y: 0,   w: 120,  h: 60 },
    { id: 'd9',  label: 'Deliverable D9',     kind: 'info', x: 140, y: 0,   w: 120,  h: 60 },
    { id: 'd7',  label: 'Deliverable D7',     kind: 'info', x: 635, y: 260,   w: 121,  h: 61 },
    { id: 'd10',  label: 'Deliverable D10',     kind: 'info', x: 280, y: 0,   w: 120,  h: 60 },
    { id: 'd11',  label: 'Deliverable D11',     kind: 'info', x: 160, y: 260,   w: 120,  h: 60 },
    { id: 'd12',  label: 'Deliverable D12',     kind: 'info', x: 320, y: 260,   w: 120,  h: 60 },
    { id: 'd13',  label: 'Deliverable D13',     kind: 'info', x: 401, y: 345,   w: 120,  h: 60 },
    { id: 'd14',  label: 'Deliverable D14',     kind: 'info', x: 591, y: 345,   w: 120,  h: 60 },
    { id: 'd15',  label: 'Deliverable D15',     kind: 'info', x: 497, y: 435,   w: 120,  h: 60 },
    { id: '4-1', label: '4.1 Requirement to Metric Translation',       kind: 'link', navigateTo: '/steps/4-metrics/examples/4-1', x: 0, y: 150, w: 120, h: 60 },
    { id: '4-2', label: '4.2 Operational Metric Definition',       kind: 'link', navigateTo: '/steps/4-metrics/examples/4-2', x: 160, y: 150, w: 121, h: 60 }, 
    { id: '4-3', label: '4.3 Environmental Metric Definition',       kind: 'link', navigateTo: '/steps/4-metrics/examples/4-3', x: 320, y: 150, w: 120, h: 60 },
    { id: '4-4', label: '4.4 Context Calibration',       kind: 'link', navigateTo: '/steps/4-metrics/examples/4-4', x: 496, y: 150, w: 120, h: 60 },
    { id: '4-5', label: '4.5 Verification or Iteration',       kind: 'link', navigateTo: '/steps/4-metrics/examples/4-5', x: 665, y: 150, w: 112, h: 60 },
...
summary: 'Within the previous steps, metrics were established, limitiations were identified and the minimum requirements for classifying hazards were established. This begs the question, what if these minimums or maximums cannot be met. How do we minimize harm within the event of a failure and what are the different levels of failure?',
diagramSrc: 'diagrams/step-5.svg',
subHotspots: [
  {id: '5-1', label: '5.1 Failure Trigger Detection', kind: 'link', navigateTo: 'steps/5-safety-actualisation/examples/5-1', x:240, y:140, w:121, h:61},
  ...
  { id: 'd15',  label: 'Deliverable D15',     kind: 'info', x: 280, y: 0,   w: 120,  h: 60 },
],
...
subHotspots: [
  {id: '6-1', label: '6.1 Technology Scoping', kind: 'link', navigateTo: 'steps/6-design-assurance/examples/6-1', x:0, y:140, w:121, h:61},
  {id: '6-2', label: '6.2 SotA TRAP', kind: 'link', navigateTo: 'steps/6-design-assurance/examples/6-2', x:160, y:140, w:121, h:61},
  {id: '6-3', label: '6.3 Operational State Validation', kind: 'link', navigateTo: 'steps/6-design-assurance/examples/6-3', x:310, y:140, w:121, h:61},
  ...
  { id: 'd9',  label: 'Deliverable D9',     kind: 'info', x: 310, y: 0,   w: 121,  h: 61},
  { id: 'd17',  label: 'Deliverable D17',     kind: 'info', x: 309, y: 260,   w: 121,  h: 61 },
{ id: 'd18',  label: 'Deliverable D18',     kind: 'info', x: 459, y: 260,   w: 121,  h: 61 },
{ id: 'd19',  label: 'Deliverable D19',     kind: 'info', x: 610, y: 260,   w: 121,  h: 61 },
],
...
subHotspots: [
 ...
 {id:'7-2', label:'7.2 State and Mode Consolidation', kind: 'link', navigateTo: 'steps/7-soc/examples/7-2', x:210, y:210, w:121, h:61},
 {id:'7-3', label:'7.3 Assurance Traceability Mapping', kind: 'link', navigateTo: 'steps/7-soc/examples/7-3', x:360, y:210, w:121, h:61},
 {id:'7-4', label:'7.4 Residual Risk Exploration', kind: 'link', navigateTo: 'steps/7-soc/examples/7-4', x:510, y:210, w:121, h:61},
 {id:'7-5', label:'7.5 Safe Operating Context', kind: 'link', navigateTo: 'steps/7-soc/examples/7-5', x:660, y:210, w:121, h:61},
 { id: 'd13',  label: 'Deliverable D13',     kind: 'info', x: 0, y: 70,   w: 101,  h: 61 },
 { id: 'd19',  label: 'Deliverable D19',     kind: 'info', x: 70, y: 0,   w: 101,  h: 61 },
 { id: 'd16',  label: 'Deliverable D16',     kind: 'info', x: 140, y: 70,   w: 101,  h: 61 },
 { id: 'd7',  label: 'Deliverable D7',     kind: 'info', x: 220, y: 0,   w: 101,  h: 61 },
 { id: 'd17',  label: 'Deliverable D17',     kind: 'info', x: 370, y: 70,   w: 101,  h: 61 },
 { id: 'd20',  label: 'Deliverable D20',     kind: 'info', x: 210, y: 335,   w: 121,  h: 61 },
 { id: 'd21',  label: 'Deliverable D21',     kind: 'info', x: 360, y: 335,   w: 121,  h: 61 },
 { id: 'd22',  label: 'Deliverable D22',     kind: 'info', x: 510, y: 335,   w: 121,  h: 61 },
 { id: 'd23',  label: 'Deliverable D23',     kind: 'info', x: 750, y: 120,   w: 121,  h: 61 },
 { id: 'd24',  label: 'Deliverable D24',     kind: 'info', x: 750, y: 300,   w: 121,  h: 61 },
 { id: 'd25',  label: 'Deliverable D25',     kind: 'info', x: 860, y: 210,   w: 121,  h: 61 },
],
